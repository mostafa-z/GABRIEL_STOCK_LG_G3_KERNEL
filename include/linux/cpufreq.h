...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ONDEMAND_LG)
extern struct cpufreq_governor cpufreq_gov_ondemand_lg;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_ondemand_lg)
