...
//BT_S : [CONBT-2457][CSP#977391] H1 WBT ISSUE
    if(new_proto == NULL)
    {
        pr_err("new_proto is NULL");
        return -EINVAL;
    }
//BT_E : [CONBT-2457][CSP#977391] H1 WBT ISSUE
...
//BT_S : [CONBT-2442][CSP#977488] Deactive Bluesleep when BT is OFF
    BT_LDISC_DBG(V4L2_DBG_INIT, "btsleep stop called");
    brcm_btsleep_stop(sleep);
//BT_E : [CONBT-2442][CSP#977488] Deactive Bluesleep when BT is OFF
...
//BT_S : [CONBT-2342]LG_BT_COMMON_IMP_KERNEL_INCREASE_LDISC_START_TIMEOUT_VALUE
//BT_S : [CONBT-2457][CSP#980989] Code position moved (WBT Fixed)
        hu->tty = 0;
        sh_ldisc_complete(hu);
//BT_E : [CONBT-2457][CSP#980989] Code position moved (WBT Fixed)
//BT_E : [CONBT-2342] LG_BT_COMMON_IMP_KERNEL_INCREASE_LDISC_START_TIMEOUT_VALUE
    }
...
//BT_S : [CONBT-2457][CSP#977391] H1 WBT ISSUE move location
    memset(hu, 0, sizeof(struct hci_uart));
//BT_E : [CONBT-2457][CSP#977391] H1 WBT ISSUE move location
